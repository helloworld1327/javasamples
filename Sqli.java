...
public class Sqli {
  public boolean authenticate(
    ...
    String query =
        "SELECT * FROM users WHERE user = '" + user + "' AND pass = '" + pass + "'"; // Unsafe

    // If the special value "foo' OR 1=1 --" is passed as either the user or pass, authentication is
    // bypassed
  ...
  public static void main(String[] args) {
    System.out.println("Testing SQLi...");
  }
}
